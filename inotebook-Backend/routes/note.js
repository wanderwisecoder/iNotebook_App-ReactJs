...
// ROUTE - 3: Update an existing Note using: PUT "/api/note/updatenote". No Login Required.
...
// ROUTE - 4: Delete an existing Note using: DELETE "/api/note/deletenote". No Login Required.
